...
** 근태 관리 시스템 동작 원리 **
1. 출결 현황 체크후 인사고과시 출결점수 반영.
2. 관리자와 직원의 메뉴가 다르다.(관리자는 직원등록 및 근태관리 수정)
3. 직원등록은 관리자에 의해 정보(사원번호 사원이름 직급 이메일)를 입력 후 등록.
4. 출근은 사원번호를 입력해 출근 처리 한다.
5. 출근 시간 지나면 지각(9:00 ~ 10:00) 결근(10:00 이후) 
6. 정시 출퇴근 시간은 (9:00 ~ 18:00)시로 한다.
...
|24.02.19|두번째 프로젝트 회의|DA#을 활용한 Database 모델링 작업 및 read me 완성|
|테스트1|테스트2|테스트3|
...
![스프린트 추적](https://github.com/dotCodeTeam/dotCode/assets/134928447/11731aa8-82ae-41dc-aec4-99e918a911e4)

** 2. 두번째 프로젝트 회의 : Data Modeling **
